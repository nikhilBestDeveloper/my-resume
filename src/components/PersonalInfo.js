    ...
    <div className={`w-full`}>
      ...
      <div className="flex flex-wrap mb-2">
        <div className="lg:w-1/4 px-4 pb-4">
          ...
          <p className={`mb-2`}>"Embarking on a journey to code my way to success.</p>
        </div>
        <div className="lg:w-1/4 px-4 pb-4">
          <h3 className={`text-xl font-bold mb-2`}>Current Title</h3>
          <p className={`mb-2`}>Android, Spring Boot, and ReactJS Mastery</p>
        </div>
        <div className="lg:w-1/4 px-4 pb-4">
          <h3 className={`text-xl font-bold mb-2`}>Contact</h3>
          <p className={`mb-2`}>+91 8839286044</p>
        </div>
        <div className="lg:w-1/4 px-4 pb-4">
      ...
      <h3 className='text-xl font-semibold underline mb-2'>Full Stack Developer & Tech Enthusiast</h3>
      <p className={`mb-2`}>
